 ...
 *       &lt;sequence&gt;
 *         &lt;element name="metricDefinition" type="{http://schemas.nav.gov.hu/OSA/2.0/metrics}MetricDefinitionType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "QueryServiceMetricsListResponseType", namespace = "http://schemas.nav.gov.hu/OSA/2.0/metrics", propOrder = {
    "metricDefinition"
})
@XmlSeeAlso({
